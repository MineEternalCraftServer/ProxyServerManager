...
public class MySQLFunc {
    ...
    public Connection open() {
        try {
            ...
            this.plugin.getLogger().log(Level.SEVERE, "Could not connect to MySQL server, error code: " + var2.getErrorCode());
        } catch (ClassNotFoundException var3) {
            this.plugin.getLogger().log(Level.SEVERE, "JDBC driver was not found in this machine.");
        }
